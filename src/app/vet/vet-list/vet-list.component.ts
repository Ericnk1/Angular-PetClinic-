...
export class VetListComponent implements OnInit {
  ...
  deleteVet(id: number): void {
    this.vetService.deleteVetById(id).subscribe(value => window.location.assign('/vet-list'));
  }

  fullyDeleteVet(id: number): void {
    this.vetService.fullyDeleteVetById(id).subscribe(value => window.location.assign('/vet-list'));
  }
  restoreVet(id: number): void {
    this.vetService.restoreVet(id).subscribe(value => window.location.assign('/vet-list'));
  }
  updateVet(vet: Vet): void {
    this.router.navigate(['/update-vet', vet.id]);
  }
